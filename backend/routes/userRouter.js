...
router.post('/create', async (req, res) =>{
    try{
        ...
        if (!searchResult){
            ...
            res.cookie('token', token, {httpOnly: false, maxAge: 30*24*60*60*1000, sameSite: 'lax'});
...
router.patch('/update', async (req, res) => {
    ...
    if(!token){
        ...
        try{
            ...
            res.cookie('token', newToken, {httpOnly: false, maxAge: 30*24*60*60*1000, sameSite: 'lax'});
